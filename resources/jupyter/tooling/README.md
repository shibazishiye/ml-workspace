...
[![Github Actions Status](https://github.com/shibazishiye/jupyter-tooling/workflows/Build/badge.svg)](https://github.com/shibazishiye/jupyter-tooling/actions/workflows/build.yml)
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/shibazishiye/jupyter-tooling/main?urlpath=lab)


A JupyterLab extension that show tool menu at top right.

This extension is composed of a Python package named `jupyterTooling`
for the server extension and a NPM package named `jupyterTooling`
...
# Change directory to the jupyterTooling directory
...
jupyter server extension disable jupyterTooling
pip uninstall jupyterTooling
```

In development mode, you will also need to remove the symlink created by `jupyter labextension develop`
command. To find its location, you can run `jupyter labextension list` to figure out where the `labextensions`
folder is located. Then you can remove the symlink named `jupyterTooling` within that folder.
...
```sh
pytest -vv -r ap --cov jupyterTooling
```
